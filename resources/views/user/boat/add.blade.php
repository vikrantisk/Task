            ...
            <div class="p-6 bg-white border-b border-gray-200">
               ...
               <form method="POST" action="{{ route('boats.store') }}">
                  ...
                  <div class="mt-4">
                     ...
                     <x-input id="length" class="block mt-1 w-full" type="number" name="length" :value="old('length')" required />
                  </div>
                  <!-- Width -->
                  <div class="mt-4">
                     <x-label for="width" :value="__('Width')" />
                     <x-input id="width" class="block mt-1 w-full" type="number" name="width" :value="old('width')" required />
                  </div>
                  <!-- HIN -->
                  <div class="mt-4">
                     <x-label for="hin" :value="__('HIN')" />
                     <x-input id="hin" class="block mt-1 w-full" type="text" name="hin" :value="old('hin')" required />
                  </div>
                  <!-- Current Mileage -->
                  <div class="mt-4">
                     <x-label for="current_hours" :value="__('Current Hours')" />
                     <x-input id="current_hours" class="block mt-1 w-full" type="number" name="current_hours" :value="old('current_hours')" step="0.01" required />
                  </div>
                  <!-- Service Interval -->
                  <div class="mt-4">
